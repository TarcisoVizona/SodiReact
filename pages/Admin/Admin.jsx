  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="flex-1">
        ...
        <div className="flex gap-13 justify-center items-start ">
          <div className="flex-1 flex-col gap-13 p-6 justify-center items-start">
            ...
            <div className="flex flex-wrap gap-6 mt-6">
              {dados?.map((element) => {
                return (
                  <div className="text-[15px] w-60 h-fit shadow-2xl p-4 rounded-2xl border border-gray-100 flex flex-col gap-2">
