...
function Cadastrar() {
  ...
  async function enviar() {
    ...
    if (!isSenhaValid) {
      alert(
        "A senha deve conter no mínimo 8 caracteres, Letras maiúscula e minúscula, além de um símbolo",
      );
      return;
    }
    ...
    <main className="flex min-h-screen bg-[#ffffff]">
      <article className="flex flex-col justify-center px-16 w-[40%]">
        ...
        <div className="flex flex-col gap-6 w-full">
          ...
          >
            <BiSolidUserCircle color="#3c8670" size={22} />
          </CampoDeTexto>
          ...
          >
            ...
            >
              {visivel ? (
                <BsEyeFill color="#3c8670" size={20} />
              ) : (
                <BsEyeSlashFill color="#3c8670" size={20} />
              )}
            </div>
          </CampoDeTexto>
      ...
      >
        <img className="w-45" src="pages/Cadastro/Icons/sodi.png" alt="logo" />
      </div>
    </main>
  );
}
